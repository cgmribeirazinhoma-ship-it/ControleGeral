/*
================================================================================
  SISTEMA DE CONTROLE DE PROCESSOS DE PAGAMENTO — React v4.6.1 (History Edit Fix)
...
async function loadAllProcessos() {
  const [atomRows, blobArr] = await Promise.all([ ST.list("proc_"), ST.get("processos") ]);
...
function NovoProcessoPage({
  ...
  /*#__PURE__*/React.createElement(SH, {
    ...
    : /*#__PURE__*/React.createElement("div", {
        ...
        onClick: () => {
          if (!isManualNum) {
            // Ao ativar manual, sugere o próximo mas deixa editar
...
/*#__PURE__*/React.createElement(Sidebar, {
    ...
    onEditar: async h => {
      ...
      if (proc) {
        ...
        // CORREÇÃO: Usa os dados do histórico como salva-vidas se o principal sumiu
        toast("⚠️ Registro principal ausente. Restaurando a partir do histórico...", "warn");
        
        const procRestaurado = {
          ...
          "_decisao": h["_decisao"] || (String(h["Decisão"] || "").includes("INDE") ? "indeferir" : "deferir"),
          "_obs": h["_obs"] || "",
          "_usuario": h["_usuario"] || "",
          "_sits": h["_sits"] || []
        };
        handleEditar(procRestaurado);
      }
    },
