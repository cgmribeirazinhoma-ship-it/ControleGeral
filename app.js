...
function Sidebar({
  ...
  }, "v4.0 \xB7 2026", /*#__PURE__*/React.createElement("span", {
...
function ProtocoloPage({ historico = [], processos = [], dark, toast, appConfig }) {
  ...
  function _cabPDF(doc, W) {
    ...
    return y; // retorna y logo abaixo da linha
  }
  ...
  const gerarPDFSistema = async () => {
    ...
    try {
      ...
      const desenharVia = (doc, isSegundaVia) => {
        ...
        // Tabela
        const cols=[
          {label:"Nº",        w:18, key:"processo"},
          {label:"Órgão",     w:40, key:"orgao"},
        ...
        itens.forEach((item,idx)=>{
          if(y>258){ doc.addPage(); y=_cabPDF(doc,W)+6; y=tHeader(y); doc.setFont("helvetica","normal"); doc.setFontSize(7); }
          if(idx%2===0){ doc.setFillColor(240,248,240); doc.rect(M,y,W-2*M,rowH,"F"); }
          let cx=M;
          const v={processo:String(item.processo||""),orgao:String(item.orgao||"").slice(0,30),fornecedor:String(item.fornecedor||"").slice(0,28),nf:String(item.nf||""),valor:item.valor?fmtBRL(item.valor):"",data:String(item.data||"")};
          cols.forEach(c=>{ doc.text(v[c.key]||"",cx+1,y+4.8,{maxWidth:c.w-2}); cx+=c.w; });
        ...
        if(y>255){ doc.addPage(); y=_cabPDF(doc,W)+8; }
        doc.setFont("helvetica","normal"); doc.setFontSize(10);
        doc.text(`Governador Edison Lobão/MA, ${hoje}`, W-M, y, {align:"right"}); y+=14;
        const xC=W/2;
        doc.setLineWidth(0.4); doc.line(xC-38,y,xC+38,y); y+=5;
        doc.setFont("helvetica","bold"); doc.setFontSize(10);
        doc.text(ctrl.nome||"Controlador(a) Geral",xC,y,{align:"center"}); y+=5;
        doc.setFont("helvetica","normal"); doc.setFontSize(9);
  ...
  return /*#__PURE__*/React.createElement("div",{style:{flex:1,background:bg,minHeight:"100vh",padding:"28px 28px 60px"}},
    ...
    /*#__PURE__*/React.createElement("div",{style:{display:"flex",gap:10,marginBottom:20,flexWrap:"wrap"}},
      [["historico","🕐 Processos do Sistema"],["manual","📨 Recebimento de Documento"]].map(([m,label])=>
        /*#__PURE__*/React.createElement("button",{
    ...
    modo==="historico" && /*#__PURE__*/React.createElement("div",null,
      /*#__PURE__*/React.createElement("div",{style:{display:"flex",gap:10,marginBottom:14,alignItems:"center",flexWrap:"wrap"}},
        /*#__PURE__*/React.createElement("input",{type:"text",placeholder:"🔍 Buscar por processo, órgão, fornecedor, NF...",value:busca,onChange:e=>setBusca(e.target.value),style:{...inp,maxWidth:380}}),
        ...
        selecionados.length>0&&/*#__PURE__*/React.createElement("span",{style:{color:MUN.green,fontWeight:700,fontSize:13}},`${selecionados.length} selecionado(s)`)
      ),
          ...
          : filtrados.map((item,idx)=>{
              ...
              return /*#__PURE__*/React.createElement("div",{
                ...
                style:{display:"flex",alignItems:"center",gap:12,padding:"10px 14px",cursor:"pointer",userSelect:"none",
                  ...
                  borderBottom:"1px solid "+bdr, borderLeft:"4px solid "+(sel?MUN.green:"transparent"),transition:"background .12s"}
              },
    ...
    modo==="manual" && /*#__PURE__*/React.createElement("div",null,
      ...
      /*#__PURE__*/React.createElement("button",{onClick:addDoc,style:{...btn(dark?"#1e4a30":"#e8f5ec",MUN.green),border:"2px dashed "+MUN.green,width:"100%",marginBottom:4}},
        "+ Adicionar outro documento")
    ),

    // ── Opção 2 vias + Botão gerar ──
    /*#__PURE__*/React.createElement("div",{style:{marginTop:22,display:"flex",gap:16,alignItems:"center",flexWrap:"wrap"}},
      /*#__PURE__*/React.createElement("button",{
