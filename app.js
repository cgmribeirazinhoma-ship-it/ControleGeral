...
async function gerarPDF(d, tipo, deferir, checklist, sits) {
  try {
    ...
    for (let ri = 0; ri < capaRows.length; ri++) {
      ...
      // Texto do label (negrito azul)
      doc.setFont("helvetica", "bold"); doc.setFontSize(10.5); doc.setTextColor(10, 40, 100);
    ...
    doc.setFillColor(10, 40, 100); doc.rect(ML2, y, MW2, titH, "F");
    ...
    function secHeader2(label, ic) {
      ...
      // Label negrito azul
      doc.setFont("helvetica", "bold"); doc.setFontSize(11); doc.setTextColor(10, 40, 100);
    ...
    // Última linha: CNPJ/CPF | Nº | Tipo | Valor R$
    {
      ...
      cols4.forEach(function(c, ci) {
        ...
        doc.setFont("helvetica", "bold"); doc.setFontSize(FS * 0.85); doc.setTextColor(10, 40, 100);
    ...
    doc.text("Ribeirãozinho do Maranhão-MA, " + fv(d.data_ateste) + ".", ML2 + MW2 - 4, y, { align: "right" }); y += LH * 1.15;
    ...
    ensureSpace(doc, 10);
    doc.setFont("helvetica", "bold"); doc.setFontSize(FS * 1.05); doc.setTextColor(10, 40, 100);
    ...
    if (y + sigH2 > SAFE) {
      doc.addPage();
      doc.setFillColor(10, 40, 100); doc.rect(0, 0, W, HDR_H, "F");
