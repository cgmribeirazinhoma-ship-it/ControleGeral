  ...
  var gerarPDFSistema = async () => {
    ...
    try {
      ...
      var desenharVia = (doc, isSegundaVia) => {
        ...
        // Assinaturas: Controlador (esquerda) + Recebedor (direita)
