// ControleGeral Service Worker v5.1.5-20260713
// Atualizado em 13/07/2026 — Adição do logging de erro detalhado do Supabase
// Estrategia:
...
const CACHE = 'cgel-v5.1.5-20260910-v78';
const SHELL = [
  '/', '/index.html', '/app.js', '/brasao.js', '/manifest.json',
  '/constants.js', '/helpers.js', '/storage.js', '/useLocks.js', '/parecer.js', '/contratos.js', '/supabase.js'
];
const CDN_URLS = [
