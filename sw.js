// ControleGeral Service Worker v5.1.5-20260711
// Atualizado em 11/07/2026 — Correção de login insensível a maiúsculas/minúsculas
// Estrategia:
...
const CACHE = 'cgel-v5.1.5-20260711-v55';
const SHELL = [
