// ControleGeral Service Worker v5.1.5-20260701
// Atualizado em 01/07/2026 — paginação dinâmica, debounce, design system e edição de órgãos
// Estrategia:
...
const CACHE = 'cgel-v5.1.5-20260701-v53';
const SHELL = [
