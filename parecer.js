...
function gerarPDFParecer(d) {
  ...
  par("Versam os presentes autos sobre solicitação de pagamento referente ao " +
      obj + " para atender as demandas do município de Governador Edison Lobão" +
      (nf ? ", relativo a NF " + nf : "") +
      ". No valor de " + vFX +
  ...
  const dataStr = "Governador Edison Lobão- MA, " + hoje.getDate() +
  ...
  const FTXT = (typeof FOOTER_TXT !== "undefined" ? FOOTER_TXT :
    "RUA IMPERATRIZ II, Nº 800, CENTRO - GOV. EDISON LOBÃO/MA  |  CEP: 65.928-000");
